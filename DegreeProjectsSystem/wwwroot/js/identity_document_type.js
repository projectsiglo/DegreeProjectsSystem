...
function loadDataTable() {
    dataTable = $('#tblData').DataTable({
        ...
        "ajax": {
            "url": "/Admin/IdentityDocumentType/GetAllIdentityDocumentTypes"
        },
        "columns": [
            { "data": "name", "width": "40%" },
            {
                    ...
                    if (!active) {
                        ...
                        return `
                            <div class="text-center">
                                ...
                                <a onclick=Delete("/Admin/IdentityDocumentType/DeleteIdentityDocumentType/${data}") class="btn btn-danger text-white" style="cursor:pointer;">
                                    <i class="far fa-trash-alt"></i>
                                </a>
                            </div>
                         `;
